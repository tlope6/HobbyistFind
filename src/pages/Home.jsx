...
const Home = () => {
  ...
  return (
    <div style={{ background: '#FAF7F4', minHeight: '100vh', fontFamily: 'DM Sans, system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', padding: '12px 16px', overflowX: 'auto', background: '#fff', borderBottom: '1px solid #F0E8E4' }}>
        {CATS.map(cat => {
      ...
      {locLoading ? (
        <div style={{ height: '380px', background: '#F4EFE9', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
      ...
      <div style={{ padding: '20px 16px 100px' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '60px 0' }}>
            ...
            <div style={{ color: '#7A6880', fontSize: '14px' }}>Try increasing the radius or changing the category</div>
          </div>
